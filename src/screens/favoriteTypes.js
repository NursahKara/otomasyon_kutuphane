...
import { View, Text, SafeAreaView, FlatList, StyleSheet, Image, Button ,ImageBackground,Dimensions} from 'react-native';
...
class FavoriteTypes extends React.Component {
    componentDidMount() {
    ...
    render() {
        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1 }}>
                <CustomHeader title="Favorileri Kategorilerin" bg_white={true} navigation={this.props.navigation} />
                <View style={{ flex:1 }}>
                <ScrollView >
                    <View style={{ flex: 1, justifyContent: 'center', marginLeft: 20,marginRight:20,marginBottom:20,marginTop:10 }}>
                            {categoriesView}
                    </View>
                    </ScrollView>
                </View>
